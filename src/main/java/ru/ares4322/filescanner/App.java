 ...
 * обработка и непосредственно сканирвоание. Для каждого этапа создано по
 ...
 * пишется в итоговый файл. Исходники алгоритма внешней сортировки взяты отсюда
 * - http://code.google.com/p/externalsortinginjava/ и немного доработаны под
 * задачу. Модульные тесты сделаны для классов парсера и обработчика параметров
 * командной строки. Для сканеров нужны функциональные тесты, так как они
 * используют в работе файловую систему.
 *
 * @author Gregory Orlov <orlov@navtelecom.ru>
 */

//@todo можно сделать один метод для внешней сортировки, например, sort и проверить на винде
public class App {
